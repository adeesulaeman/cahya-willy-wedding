...
(function($, Happy, w) {
    ...
    $window.on("elementor/frontend/init", function() {
        ...
        var NavMenu = function _init($scope) {
            if ($scope.find(".ha-menu-container").length > 0) {
                ...
                sidebar_mousemove.on("mouseenter", function() {
                    ...
                    if (!$(this).hasClass("ha-dropdown-menu-full_width") &&
                        $(this).hasClass("top_position")
                    ) {
                        $(this).on({
        ...
        var Unfold = elementorModules.frontend.handlers.Base.extend({
            ...
            onElementChange: function(e) {
                if (e == 'unfold_text' || e == 'unfold_icon' || e == 'fold_text' || e == 'fold_icon' || e == 'fold_height' || e == 'transition_duration') {
                    globalUnfoldSettings = this.getReadySettings();
                    if (e == 'fold_height') {
            ...
            getCollapseHeight: function() {
                ...
                if (body.attr('data-elementor-device-mode') == 'desktop') {
                    collapse_height = globalUnfoldSettings.collapse_height;
                }

                if (body.attr('data-elementor-device-mode') == 'tablet') {
                    collapse_height = globalUnfoldSettings.collapse_height_tablet;
                }

                if (body.attr('data-elementor-device-mode') == 'mobile') {
                    collapse_height = globalUnfoldSettings.collapse_height_mobile;
                }
            ...
            fold: function(unfoldData, button, collapse_height) {
                var html = (globalUnfoldSettings.collapse_icon) ? ((globalUnfoldSettings.collapse_icon.value) ? '<i aria-hidden="true" class="' + globalUnfoldSettings.collapse_icon.value + '"></i>' : '') : '';
                html += (globalUnfoldSettings.collapse_text) ? '<span>' + globalUnfoldSettings.collapse_text + '</span>' : '';

                unfoldData.css('transition-duration', globalUnfoldSettings.transition_duration + 'ms');
                ...
                var timeOut = setTimeout(function() {
                    button.html(html);
                    clearTimeout(timeOut)
                }, globalUnfoldSettings.transition_duration);

                unfoldData.removeClass("folded");
            },

            unfold: function(unfoldData, unfoldRender, button) {
                var html = (globalUnfoldSettings.expand_icon) ? ((globalUnfoldSettings.expand_icon.value) ? '<i aria-hidden="true" class="' + globalUnfoldSettings.expand_icon.value + '"></i>' : '') : '';
                html += (globalUnfoldSettings.expand_text) ? '<span>' + globalUnfoldSettings.expand_text + '</span>' : '';
            ...
            run: function() {
                ...
                if (globalUnfoldSettings.trigger == 'click') {
                ...
                } else if (globalUnfoldSettings.trigger == 'hover') {
